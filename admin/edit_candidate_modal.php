	...
	<?php 
		...
		if(ISSET($_POST['update'])){
			...
			if ($_FILES['image']['size'] == 0) {
				...
				$conn->query("UPDATE candidate SET position = '$position', firstname = '$firstname', lastname = '$lastname', year_level = '$year_level', gender = '$gender' WHERE candidate_id = '$candidate_id'")or die($conn->error);
